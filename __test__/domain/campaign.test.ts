import { assertNotFinalizada, assertUniqueMissionName, Campaign, CampaignI, CharacterRef, EmbeddedItem, EmbeddedMission, EmbeddedSession, GroupSnapshot, Inventory, MissionStatusType, validateCampaign, validateCharacterRef, validateEmbeddedItem, validateEmbeddedMission, validateEmbeddedSession, validateGroupSnapshot, validateInventory } from "@/domain/campaign/campaign";
