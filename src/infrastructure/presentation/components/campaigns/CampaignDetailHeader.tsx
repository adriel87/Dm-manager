...
import { BookIcon, CalendarIcon, ArrowLeftIcon } from '@/infrastructure/presentation/components/icons';
      ...
      <div className="flex flex-wrap items-center gap-5 border-t border-zinc-800 pt-4">
        ...
        {campaign.group && (
          <span className="text-zinc-400 text-sm">
            Grupo:{' '}
            <span className="text-white font-semibold">{campaign.group.name}</span>
          </span>
        )}
      </div>
    </header>
