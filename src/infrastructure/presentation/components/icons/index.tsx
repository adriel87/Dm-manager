...
/** Chevron pointing down — rotates 180° when expanded */
...
/** Chevron pointing right — rotates 90° when expanded */
...
/** Info circle — circle with vertical line and dot */
export function InfoCircleIcon({ className = '', size = 16 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
...
/** Filled circle — used as a status dot indicator */
export function DotFilledIcon({ className = '', size = 12 }: IconProps) {
  return (
